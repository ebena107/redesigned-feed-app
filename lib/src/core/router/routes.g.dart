...
RouteBase get $homeRoute => GoRouteData.$route(
      ...
      routes: [
        ...
        GoRouteData.$route(
          path: '/newIngredient',
          factory: $NewIngredientRoute._fromState,
        ),
        GoRouteData.$route(
          path: '/importWizard',
          factory: $ImportWizardRoute._fromState,
        ),
        GoRouteData.$route(
          path: '/formulator',
          factory: $FeedFormulatorRoute._fromState,
        ),
        GoRouteData.$route(
          path: '/settings',
...
mixin $NewIngredientRoute on GoRouteData {
  static NewIngredientRoute _fromState(GoRouterState state) =>
      NewIngredientRoute(
        ingredientId: state.uri.queryParameters['ingredient-id'],
      );

  NewIngredientRoute get _self => this as NewIngredientRoute;

  @override
  String get location => GoRouteData.$location(
        '/newIngredient',
        queryParams: {
          if (_self.ingredientId != null) 'ingredient-id': _self.ingredientId,
        },
      );
...
mixin $ImportWizardRoute on GoRouteData {
...
mixin $FeedFormulatorRoute on GoRouteData {
