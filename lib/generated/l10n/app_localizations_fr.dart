...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get navFeedFormulator => 'Formulateur';
  ...
  @override
  String get screenTitleImportWizard => 'Assistant d\'importation';

  @override
  String get screenTitleFeedFormulator => 'Formulateur d\'aliments';
  ...
  String formulatorStepIndicator(int step, int total) {
    return 'Etape $step sur $total';
  }

  @override
  String get formulatorStepAnimal => 'Profil de l\'animal';

  @override
  String get formulatorStepIngredients => 'Selectionner les ingredients';

  @override
  String get formulatorStepConstraints => 'Definir les objectifs nutritionnels';

  @override
  String get formulatorStepResults => 'Formule optimisee';

  @override
  String get formulatorSelectIngredientsHint =>
      'Choisissez des ingredients pour l\'optimisation';

  @override
  String get formulatorSearchIngredients => 'Rechercher des ingredients';

  @override
  String get formulatorIngredientSearchHint => 'Rechercher par nom';
  ...
  @override
  String get formulatorSelectAll => 'Tout selectionner';

  @override
  String get formulatorResetSelection => 'Effacer la selection';
  ...
  @override
  String get formulatorConstraintHelp => 'Laissez vide pour ignorer une borne';
  ...
  String get formulatorNoResults =>
      'Lancez l\'optimisation pour voir les resultats.';

  @override
  String get formulatorStatusSolving => 'Optimisation...';

  @override
  String get formulatorStatusFailed => 'Echec de l\'optimisation';

  @override
  String get formulatorStatusInfeasible =>
      'Aucune solution faisable avec les contraintes actuelles.';

  @override
  String get formulatorStatusUnbounded =>
      'Optimisation non bornee. Verifiez les contraintes.';

  @override
  String get formulatorCostPerKg => 'Cout par kg';

  @override
  String get formulatorNutrientsSummary => 'Resume des nutriments';

  @override
  String get formulatorIngredientMix => 'Melange d\'ingredients';

  @override
  String get formulatorWarnings => 'Avertissements';

  @override
  String get formulatorEmptySelection =>
      'Selectionnez au moins un ingredient pour continuer.';

  @override
  String get formulatorLoadingAnimals => 'Chargement des types d\'animaux...';

  @override
  String formulatorLoadAnimalsFailed(String error) {
    return 'Echec du chargement des types d\'animaux : $error';
  }
  ...
  @override
  String get regionAll => 'Toutes les Régions';
  ...
  @override
  String get formSectionBasicInfo => 'Informations de base';

  @override
  String get formSectionEnergyValues => 'Valeurs énergétiques';

  @override
  String get formSectionMacronutrients => 'Macronutriments';

  @override
  String get formSectionMicronutrients => 'Micronutriments';

  @override
  String get formSectionCostAvailability => 'Coût et disponibilité';

  @override
  String get formSectionAdditionalInfo => 'Informations supplémentaires';

  @override
  String get fieldHintEnergyMode =>
      'Saisir des valeurs d\'énergie pour chaque groupe spécifique d\'animaux ?';

  @override
  String get fieldLabelAdultPigs => 'Porcs adultes';

  @override
  String get fieldLabelGrowingPigs => 'Porcs en croissance';

  @override
  String get fieldLabelPoultry => 'Volaille';

  @override
  String get fieldLabelRabbit => 'Lapin';

  @override
  String get fieldLabelRuminant => 'Ruminant';

  @override
  String get fieldLabelFish => 'Poisson';

  @override
  String get fieldLabelCreatedBy => 'Créé par';

  @override
  String get fieldLabelNotes => 'Notes';

  @override
  String get customIngredientHeader => 'Création d\'un ingrédient personnalisé';

  @override
  String get customIngredientDescription =>
      'Vous pouvez ajouter votre propre ingrédient avec des valeurs nutritionnelles personnalisées';

  @override
  String get newIngredientTitle => 'Nouvel ingrédient';

  @override
  String get fieldLabelFeedName => 'Nom de l\'aliment';

  @override
  String get fieldLabelAnimalType => 'Type d\'animal';

  @override
  String get fieldLabelProductionStage => 'Stade de production';
  ...
  String missingPriceWarning(int count) {
    return 'Prix manquant pour $count ingrédients; utilisation du prix moyen.';
  }

  @override
  String get addMoreIngredientsRecommendation =>
      'Ajoutez plus d\'ingrédients (au moins 3-5 recommandés) pour plus de flexibilité afin de répondre aux objectifs nutritionnels.';

  @override
  String get tightenedConstraintsRecommendation =>
      'Les exigences nutritionnelles peut être trop strictes pour les ingrédients sélectionnés. Essayez d\'élargir les plages min/max de 5-10%.';

  @override
  String get addHigherNutrientIngredientsRecommendation =>
      'Sinon, ajoutez des ingrédients de plus haute densité nutritionnelle dans les nutriments limitants.';

  @override
  String conflictingConstraintsError(String min, String max) {
    return 'Minimum ($min) dépasse maximum ($max). Veuillez corriger ceci.';
  }

  @override
  String narrowRangeWarning(String range) {
    return 'Plage très étroite ($range). Essayez de l\'élargir de 10-20%.';
  }

  @override
  String nutrientCoverageIssue(String max, String min, String nutrient) {
    return 'Maximum disponible des ingrédients est $max, mais minimum requis est $min. Réduisez l\'exigence ou sélectionnez des ingrédients avec $nutrient plus élevé.';
  }

  @override
  String get lowInclusionLimitsWarning =>
      'Plusieurs ingrédients ont des limites d\'inclusion maximale très basses. Ajoutez des ingrédients plus diversifiés pour équilibrer les contraintes.';

  @override
  String totalInclusionLimitWarning(String total) {
    return 'L\'inclusion maximale totale des ingrédients sélectionnés est $total%. Ajoutez plus d\'ingrédients ou augmentez les limites individuelles.';
  }
}
